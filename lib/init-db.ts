...
export async function ensureSchema() {
  ...
  await sql`CREATE INDEX IF NOT EXISTS idx_user_tv_series_user_id ON user_tv_series(user_id)`;
  await sql`CREATE INDEX IF NOT EXISTS idx_lists_user_id ON lists(user_id)`;
  await sql`CREATE INDEX IF NOT EXISTS idx_list_items_list_id ON list_items(list_id)`;
